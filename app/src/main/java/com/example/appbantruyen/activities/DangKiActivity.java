    ...
    private void initController() {
        buttondk.setOnClickListener(new View.OnClickListener() {
            ...
            private void dangKi() {
                ...
                //Kiem tra nguoi dung co dien day du thong tin ko
                if(TextUtils.isEmpty(str_email)){
                    ...
                    if(str_pass.equals(str_repass)){
                        // post data
                        compositeDisposable.add(apidangnhap.dangKi(str_email,str_pass,str_user,str_mobile)
                                .subscribeOn(Schedulers.io())
                                .observeOn(AndroidSchedulers.mainThread())
                                .subscribe(
                                        userModel -> {
                                            if(userModel.isSuccess()){
                                                //Luu san email va pass ben man hinh dang nhap
                        ...
                        //Nhap lai repass dung voi o tren
